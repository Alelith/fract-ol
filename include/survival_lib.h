...
/**
 * @page survlib_page Survival Library
 * 
 ...
 * library.
 * 
 * @section functions_survlib_sec Functions
 ...
 * 
 * @section author_survlib_sec Authors
